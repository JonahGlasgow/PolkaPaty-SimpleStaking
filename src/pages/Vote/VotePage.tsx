...
import { PROPOSAL_LENGTH_IN_SECS, COMMON_CONTRACT_NAMES, Polp, ZERO_ADDRESS } from '../../constants'
...
export default function VotePage({
  ...
  const uniBalance: TokenAmount | undefined = useTokenBalance(account ?? undefined, chainId ? Polp[chainId] : undefined)
