  ...
  return (
    <Wrapper showBackground={isStaking} bgColor={backgroundColor}>
      ...
      <TopSection>
        ...
        <StyledInternalLink to={`/POLP/${currencyId(currency0)}`} style={{ width: '100%' }}>
      ...
      <StatContainer>
        <RowBetween>
          <TYPE.white>Pool Duration</TYPE.white>
          <TYPE.white>
        ...
        <RowBetween>
          ...
          <TYPE.white>{`${stakingInfo.totalRewardRate
            ?.multiply(`${60 * 60 * 24 * 7}`)
            ?.toFixed(0, { groupSeparator: ',' })} POLP / week`}</TYPE.white>
        </RowBetween>
      </StatContainer>
          ...
          <BottomSection showBackground={true}>
            ...
            <TYPE.black style={{ textAlign: 'right' }} color={'white'} fontWeight={500}>
              ...
              {`${stakingInfo.rewardRate
                ?.multiply(`${60 * 60 * 24 * 7}`)
                ?.toSignificant(4, { groupSeparator: ',' })} POLP / week`}
            </TYPE.black>
          </BottomSection>
        </>
      )}
